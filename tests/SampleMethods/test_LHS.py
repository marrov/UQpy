...
def test_samples1():
    ...
    expected_samples = np.array([0.94, 0.14,  0.45, 0.71, 0.26])
...
def test_samples2():
    ...
    expected_samples = np.array([[0.14, 0.26], [0.26, 0.94], [0.94, 0.71], [0.71, 0.14], [0.45, 0.45]])
...
def test_samples5():
    ...
    expected_samples = np.array([[0.25, 0.56], [0.72, 0.25], [0.06, 0.06], [1.00, 0.72], [0.56, 1.00]])
